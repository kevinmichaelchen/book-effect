...
This project uses [NX Release][nx-release] with [conventional commits][conventional-commits] for automated versioning.
...
The `--skip-publish` flag is used because publishing to npm is handled by GitHub Actions when the tag is pushed.
